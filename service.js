(function(app){
    ...
    app.service("gameEngine", function(playerFactory, simonFactory ,COLORME, $timeout){
        var self = this;
        ...
        self.colors = {
            "red": COLORME["red"].color,
            "green": COLORME["green"].color,
            "blue": COLORME["blue"].color,
            "yellow": COLORME["yellow"].color
        };
        ...
        self.changeColors = function(colorValue, selectedValue){
            if(selectedValue){
                self.colors[colorValue] = COLORME[colorValue].lightColor;
            }
            else{
                self.colors[colorValue] = COLORME[colorValue].color;
            }
        };
